...
//     const { data, isLoading, error } = useGetYearToCourseQuery({ courseId });
...
//     if (error) return <Typography>Error loading years</Typography>;
...
//                 </TableHead>
//                 <TableBody>
//                     {data.years.map((year: { _id: string, year: number }, index: number) => (
